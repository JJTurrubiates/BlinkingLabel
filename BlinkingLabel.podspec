...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jesus Turrubiates/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jesus Turrubiates' => 'jesus.guerrero.turrubiates@gmail.com' }
  s.source           = { :git => 'https://github.com/Jesus Turrubiates/BlinkingLabel.git', :tag => s.version.to_s }
